...
sepTags <- as.list(strsplit(full_dat$tags, ",")) %>%
  ...
  filter(valClean != "0") # videos with zero tags got this label
...
Are the popular tags for all Alex Jones videos the same ones used for mainstream-media related videos? By examing the most widely-used tags on the subset videos related to mainstream media, I find striking distinctions between the two groups. 
...
There is expected overlap between the most popular tags in the mainstream-video subset and all videos: "Alex Jones", "Info Wars", and "Alternative Media" all appear in the top six most widely-used tags in both groups. In the mainstream media-related subset, "Hillary Clinton", "Truth", and "9/11" feature more prominently as tags. 

Because the same video often accounts for multiple tags, we cannot compare the raw number of tags to contrast the two groups.  
