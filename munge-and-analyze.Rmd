...
skim(full_dat, commentCount, dislikeCount, likeCount, viewCount, year) %>%
...
skim(ms_dat, commentCount, dislikeCount, likeCount, viewCount, year) %>% skimr::kable(caption = "Summary statistics for mainstream-related video subset")
```
...
```{r count_tags_all_vids_plot, fig.align="center", fig.width=20, fig.height = 10}
...
```{r ms_tag_count_plot, echo = FALSE, fig.align="center", fig.width=20, fig.height = 10}
...
```{r all_tag_compare_fig, fig.align="center", warning=FALSE, fig.width=20, fig.height = 10}
